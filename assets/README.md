...
The current corridor web preview directly uses the firmware asset package and C renderer; generated font data comes from `main/corridor_font.c`. See [web sync](../docs/WEB_PREVIEW_EXIT_CORRIDOR.md) for shared sources, rebuilding and boundaries.
