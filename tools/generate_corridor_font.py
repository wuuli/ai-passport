...
output = root/'main/corridor_font.c'
subprocess.run([args.converter, '--size', '16', '--bpp', '2', '--format', 'lvgl',
                '--no-compress', '--no-kerning', '--lv-include', 'lvgl.h',
                '--font', args.font, '--symbols', symbols, '-r', '32-126', '-o', str(output)], check=True)
