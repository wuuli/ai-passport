...
《掐秒挑战》把一台 AI Passport 变成共享的时间感竞技场。两名玩家看到相同的 1.0～6.0 秒目标后，轮流按 OK 开始和停止，在没有计时显示的情况下全凭感觉估算。误差更小者赢下回合，率先三胜者赢得整场。

本版包含同机双人、成绩封存、独立的回合与整场胜利动画、原创街机音乐、按键反馈和实时电量显示。
...
中文简介：把 AI Passport 变成双人时间感竞技场。两名玩家共用一台设备，看到 1.0～6.0 秒的目标后轮流按 OK 开始和停止，全凭感觉掐秒；误差更小者赢下回合，率先三胜赢得整场。包含独立的回合／整场动画、原创街机音乐和按键反馈。
